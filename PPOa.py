...
def train(env, policy: ActorCritic, optimizer, discount_factor:float, ppo_steps:int, ppo_clip:float):
    ...
    state = env.reset()[0] # .detach() only on tensors, i.e. not applicable to this end.
